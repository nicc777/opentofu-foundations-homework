...
locals {
  ...
  parsed_user_data                  = [slice(local.split_user_data, 0, 9), local.exchange_rate_env_string, local.exchange_rate_currency_env_string, local.cat_fact_env_string, local.split_user_data[10]]
