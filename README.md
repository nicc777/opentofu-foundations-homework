...
* Used https://library.tf/ for documentation on the AWS provider, for example how to create [aa SecretsManager Resource](https://library.tf/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret)
